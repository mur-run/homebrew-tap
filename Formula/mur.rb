class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.23/mur-aarch64-apple-darwin.tar.gz"
      sha256 "212f1cf3cc0950322a178825728584e9bcf9c28ad83cf4b5331e768634654882"
    end
  end
