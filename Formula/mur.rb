class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.7/mur-aarch64-apple-darwin.tar.gz"
      sha256 "ba2406a92d0a84f7b268dcec8ada8ef3e924db2a9eaff3dbd2930415d9e5afd3"
    end
  end
