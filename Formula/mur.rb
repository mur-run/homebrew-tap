class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.3/mur-aarch64-apple-darwin.tar.gz"
      sha256 "d489be63fe2a4ef0d7e25067d0a57f198b524a6644002fc3ba2e12a3ce02a5ac"
    end
  end
