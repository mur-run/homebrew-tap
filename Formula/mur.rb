class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.88.0/mur-aarch64-apple-darwin.tar.gz"
      sha256 "fe5103d99260345a57b7fd522765f463a0a9ca597a11c55b8e2561b77fa5282f"
    end
  end
