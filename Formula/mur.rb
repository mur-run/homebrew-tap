class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.74.0/mur-aarch64-apple-darwin.tar.gz"
      sha256 "00fb58b73ded14b068ba71034c6797b01262b839d30e19d9f5eb5211b11acaf9"
    end
  end
