class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.81.1/mur-aarch64-apple-darwin.tar.gz"
      sha256 "0b63ef0d8e9a59c977f958e71076654db7ff32d7d185726716b0dbd5428c224e"
    end
  end
