class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.77.0/mur-aarch64-apple-darwin.tar.gz"
      sha256 "ddde59688bab4fb4d91070db47547016a0d25448ebb7123adf82b3f758362f44"
    end
  end
