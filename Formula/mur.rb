class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.81.0/mur-aarch64-apple-darwin.tar.gz"
      sha256 "62de99d762f4822f9e890919ffc26920e35f8b772a5dd56ec135be34762a0228"
    end
  end
