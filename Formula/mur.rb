class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.83.0/mur-aarch64-apple-darwin.tar.gz"
      sha256 "e6c2a7a0842edec03a3a85037b58f504aaa9e76142fbd2b42de172b66e310e28"
    end
  end
