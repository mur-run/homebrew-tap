class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.77.2/mur-aarch64-apple-darwin.tar.gz"
      sha256 "cc244b160bf8382dc145e929e462ed1b80cf418889ac0cb445e3f43094398653"
    end
  end
