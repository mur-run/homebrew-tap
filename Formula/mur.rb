class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.9/mur-aarch64-apple-darwin.tar.gz"
      sha256 "ca59a20035690a14759620762e209df5df3f58c51c6ba9ead2ab56989169e8b5"
    end
  end
