class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.5/mur-aarch64-apple-darwin.tar.gz"
      sha256 "1e988ab28d747d7a1607a551aea33e4053f6dddb1e44f2c1472f4f819257bfb9"
    end
  end
