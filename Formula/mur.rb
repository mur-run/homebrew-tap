class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.15/mur-aarch64-apple-darwin.tar.gz"
      sha256 "1e7d911eef5207592c76d79100af89111df3f48e8b250895ce509c74cdb19af9"
    end
  end
