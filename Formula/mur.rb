class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.22/mur-aarch64-apple-darwin.tar.gz"
      sha256 "f95168b011490e51bffebf7e6f8c23c66904757613fa108dd380b2dbdecd96c3"
    end
  end
