class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.4/mur-aarch64-apple-darwin.tar.gz"
      sha256 "c3d6271a8a77daf0e44e6f18c07cc98a1ca179a824f9151c9f98df3d86adf590"
    end
  end
