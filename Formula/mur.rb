class Mur < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/mur-run/mur/releases/download/v2.71.6/mur-aarch64-apple-darwin.tar.gz"
      sha256 "1c2cd12f607fd4c8e3a33f45ef04dbbf47802d35c4cb61e208bf9fce41d793f6"
    end
  end
